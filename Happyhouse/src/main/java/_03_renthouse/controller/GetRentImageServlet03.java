...
@WebServlet(
		urlPatterns={"/rentimage3"},
		initParams={
				@WebInitParam(name="defaultFile", value="/img/samplehouse.jpg")
		}
		)
public class GetRentImageServlet03 extends HttpServlet {
...
//    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String id = request.getParameter("renthouse_id");
		...
		String SELECT_IMAGE="SELECT renthouse_photo3_name, renthouse_photo3 from renthouse where renthouse_id=?";
...
//		+ " from sellhouse where sellhouse_id=?";
		...
		try {
			...
			if (rset.next()){
				name=rset.getString("renthouse_photo3_name");
				is1=rset.getBinaryStream("renthouse_photo3");
