...
public String toString() {
	return "cartssellBean [cart_id=" + cart_id + ", user_account="
			+ user_account + ", sellhouse_name=" + sellhouse_name
			+ ", sellhouse_price=" + sellhouse_price + ", sellhouse_patterns="
			+ sellhouse_patterns + ", sellhouse_address=" + sellhouse_address
			...
			+ ", sellhouse_photo1=" + sellhouse_photo1 + ", sellhouse_photo2="
			+ sellhouse_photo2 + ", sellhouse_photo3=" + sellhouse_photo3 + "]";
}
/**
 * @return the cart_id
 */
