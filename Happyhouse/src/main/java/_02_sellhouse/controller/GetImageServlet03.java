...
//    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InputStream is4=new FileInputStream("C:/Users/Public/Pictures/Sample Pictures/3.jpg");
		PreparedStatement pstmt=null;
		ResultSet rset=null;
		DataSource dataSource;
		//SELECT sellhouse_photo1_name,sellhouse_photo1 from sellhouse where sellhouse_id='109'
		String SELECT_IMAGE="SELECT sellhouse_photo3 from sellhouse where sellhouse_id=?";
