...
@WebServlet(
		urlPatterns={"/newimage2"},
		initParams={
				@WebInitParam(name="defaultFile", value="/img/samplehouse.jpg")
		}
		)

public class GetNewImgServlet02 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String SELECT_IMAGE="  SELECT new_photo2_name, new_photo2 from news where new_id= ?";
		...
		try {
			...
			if (rset.next()){
				name=rset.getString("new_photo2_name");
				is1=rset.getBinaryStream("new_photo2");
