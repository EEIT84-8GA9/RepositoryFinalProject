...
<!-- 								value="Clear" onclick="clearForm()"></td> -->
	                 ...
	                 <li class="a">${update.new_describe}  <br> 更新圖片為:  <img style="border: 10px solid #FFF;" alt="image" src="${pageContext.servletContext.contextPath}/newimage1?new_id=${update.new_id}" width="150px"></li>
...
<!-- 	<script src="//libs.useso.com/js/jquery/2.1.1/jquery.min.js" type="text/javascript"></script> -->
 	<script src="/Happyhouse/js/libjquery.min.js" type="text/javascript"></script> 
