...
@WebServlet(
		urlPatterns={"/rentimage1"},
		initParams={
				@WebInitParam(name="defaultFile", value="/img/samplehouse.jpg")
		}
		)
public class GetRentImageServlet01 extends HttpServlet {
...
//    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String SELECT_IMAGE="SELECT renthouse_photo1_name, renthouse_photo1 from renthouse where renthouse_id=?";
...
//		+ " from sellhouse where sellhouse_id=?";
		...
		try {
			...
			if (rset.next()){
				name=rset.getString("renthouse_photo1_name");
				is1=rset.getBinaryStream("renthouse_photo1");
