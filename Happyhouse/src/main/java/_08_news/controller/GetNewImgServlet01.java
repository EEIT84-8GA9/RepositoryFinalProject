...
@WebServlet(
		urlPatterns={"/newimage1"},
		initParams={
				@WebInitParam(name="defaultFile", value="/img/space.png")
		}
		)

public class GetNewImgServlet01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String SELECT_IMAGE="  SELECT new_photo1_name, new_photo1 from news where new_id= ?";
		...
		try {
			...
			if (rset.next()){
				name=rset.getString("new_photo1_name");
				is1=rset.getBinaryStream("new_photo1");
