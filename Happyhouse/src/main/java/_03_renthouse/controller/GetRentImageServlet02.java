...
@WebServlet(
		urlPatterns={"/rentimage2"},
		initParams={
				@WebInitParam(name="defaultFile", value="/img/samplehouse.jpg")
		}
		)
public class GetRentImageServlet02 extends HttpServlet {
...
//    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String SELECT_IMAGE="SELECT renthouse_photo2_name, renthouse_photo2 from renthouse where renthouse_id=?";
...
//		+ " from sellhouse where sellhouse_id=?";
		...
		try {
			...
			if (rset.next()){
				name=rset.getString("renthouse_photo2_name");
				is1=rset.getBinaryStream("renthouse_photo2");
